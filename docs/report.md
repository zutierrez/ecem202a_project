...
* **Case 1**: Image Classification program
    ...
    * We also used the “Average” function of the multimeter, which averages the most recent 8 measurements. For further clarification, 2-4 measurements are taken each second by the multimeter. We found that the average current consumption of the device with the image classification program was around 26 mA.![case1](https://user-images.githubusercontent.com/6758294/145184659-5b664ed7-b694-432c-b99d-f300ec5a5615.png)
